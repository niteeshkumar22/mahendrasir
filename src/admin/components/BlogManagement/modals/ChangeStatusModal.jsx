...
const ChangeStatusModal = ({
  ...
  const handleChangeStatusClick = () => {
    handleModifyBlog(type, reason);
  };
  // const updateReason = useMemo(
  //   () =>
  //     debounce((value) => {
  //       setReason(value);
  //     }, 1000),
    ...
    <AdminModal onCancel={handleCancel} footer={null} closable={false}>
      <div>
        ...
        <div className="col-12 text-end">
          ...
          <button
            className={`btn-sach bg-sach-red ${reason.length < 3 ? "disable" : ""}`}
            onClick={ () => {
